...
export default function Board() {
  ...
  function moveLinkedList(linkedlist) {
    ...
    if (direction === "LEFT")
      ...
      (newHead = new Node(board[linkedlist.head.row][linkedlist.head.col + 1])),
        linkedlist.head.row,
        linkedlist.head.col + 1;
    else if (direction === "DOWN")
      (newHead = new Node(board[linkedlist.head.row + 1][linkedlist.head.col])),
        linkedlist.head.row + 1,
        linkedlist.head.col;
    else if (direction === "top")
      newHead = new Node(
        board[linkedlist.head.row - 1][linkedlist.head.col],
        linkedlist.head.row - 1,
        linkedlist.head.col
      );
